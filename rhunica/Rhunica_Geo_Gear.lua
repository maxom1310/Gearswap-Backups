...
function init_gear_sets()
	...
	sets.precast.FC.Geomancy = set_combine(sets.precast.FC, {range="Dunna",ammo=empty, back={ name="Lifestream Cape", augments={'Geomancy Skill +6','Indi. eff. dur. +20',}},})
	...
	sets.precast.WS = {    main={ name="Idris", augments={'Path: A',}},
    sub="Genmei Shield",
    ...
    body={ name="Merlinic Jubbah", augments={'Mag. Acc.+30','"Fast Cast"+5',}},
    hands="Agwu's Gages",
    legs="Azimuth Tights +3",
    feet="Azimuth Gaiters +3",
    neck="Erra Pendant",
	...
	sets.midcast.Phalanx = set_combine(sets.midcast['Enhancing Magic'], {hands={ name="Merlinic Dastanas", augments={'MND+10','Pet: Mag. Acc.+19 Pet: "Mag.Atk.Bns."+19','Phalanx +4',}},legs={ name="Merlinic Shalwar", augments={'"Fast Cast"+3','Pet: INT+4','Phalanx +2','Accuracy+12 Attack+12',}},})
	...
	sets.Phalanx_Received = {hands={ name="Merlinic Dastanas", augments={'MND+10','Pet: Mag. Acc.+19 Pet: "Mag.Atk.Bns."+19','Phalanx +4',}},legs={ name="Merlinic Shalwar", augments={'"Fast Cast"+3','Pet: INT+4','Phalanx +2','Accuracy+12 Attack+12',}},}
