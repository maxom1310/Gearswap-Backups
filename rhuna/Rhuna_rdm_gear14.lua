function user_job_setup()
	...
	state.Weapons:options('DualWeapons','Maxentius','Naegling','DualBlackHalo','Crocea','Evisceration')
...
function init_gear_sets()
	...
	sets.precast.WS['Black Halo'] = {range=empty,ammo="Aurgelmir Orb",
	head="Nyame Helm", 
    body="Nyame Mail",
    hands="Nyame Gauntlets",
    legs="Nyame Flanchard",
	...
	sets.precast.WS['Seraph Blade'] = {range=empty,ammo="Regal Gem",
		...
		body="Lethargy Sayon +3",hands="Lethargy Gantherots +3",ring1="Metamorph Ring +1",ring2="Epaminondas Ring",
		back={ name="Sucellos's Cape", augments={'MND+20','Mag. Acc+20 /Mag. Dmg.+20','MND+10','Weapon skill damage +10%','Damage taken-5%',}},
		waist="Orpheus Sash",legs="Lethargy Fuseau +3",feet="Leth. Houseaux +3"}
	...
	sets.TreasureHunter = set_combine(sets.TreasureHunter, {ammo="Perfect Lucky Egg",waist="Chaac Belt",hands="Volte Bracers"})
	...
	sets.midcast['Enhancing Magic'] = {main="Colada",sub="Ammurapi Shield",range=empty,ammo="Hasty Pinion +1",
		...
		back=gear.nuke_jse_back,waist="Embla Sash",legs="Atrophy Tights +3",feet="Leth. Houseaux +3"}
    ...
    hands="Regal Cuffs",
    legs={ name="Chironic Hose", augments={'Mag. Acc.+25 "Mag.Atk.Bns."+25','"Drain" and "Aspir" potency +10','INT+3','Mag. Acc.+14','"Mag.Atk.Bns."+6',}},
	...
	sets.midcast.Sleep = {main="Daybreak",
    sub="Ammurapi Shield",
    Range="Kaja Bow",
    Ammo=empty,
	head={ name="Viti. Chapeau +3", augments={'Enfeebling Magic duration','Magic Accuracy',}},
	...
	sets.midcast.Sleep = set_combine(sets.midcast.DurationOnlyEnfeebling,{range="Kaja Bow", 
	back={ name="Sucellos's Cape", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','Mag. Acc.+10','"Fast Cast"+10','Phys. dmg. taken-10%',}}})
	...
	sets.midcast.Bind.Resistant = set_combine(sets.midcast['Enfeebling Magic'].Resistant,{back={ name="Sucellos's Cape", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','Mag. Acc.+10','"Fast Cast"+10','Phys. dmg. taken-10%',}},waist="Acuity Belt +1"})
	sets.midcast.Break = set_combine(sets.midcast.DurationOnlyEnfeebling,{back={ name="Sucellos's Cape", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','Mag. Acc.+10','"Fast Cast"+10','Phys. dmg. taken-10%',}},waist="Acuity Belt +1"})
	sets.midcast.Break.Resistant = set_combine(sets.midcast['Enfeebling Magic'].Resistant,{back={ name="Sucellos's Cape", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','Mag. Acc.+10','"Fast Cast"+10','Phys. dmg. taken-10%',}},waist="Acuity Belt +1"})
	
	sets.midcast.Dispel = sets.midcast['Enfeebling Magic'].Resistant
	
	sets.midcast.SkillBasedEnfeebling = set_combine(sets.midcast['Enfeebling Magic'], {ear1="Snotra Earring",hands="Leth. Gantherots +3",ring1="Stikini Ring +1",legs="Psycloth Lappas"})
	...
	sets.midcast['Gravity'] = {sub="Ammurapi Shield",
    ammo="Regal Gem",
    head={ name="Viti. Chapeau +3", augments={'Enfeebling Magic duration','Magic Accuracy',}},
	...
	sets.midcast['Gravity II'] = {sub="Ammurapi Shield",
    ammo="Regal Gem",
    head={ name="Viti. Chapeau +3", augments={'Enfeebling Magic duration','Magic Accuracy',}},
    body="Lethargy Sayon +3",
    hands="Regal Cuffs",
	...
	sets.midcast.Impact = {main="Daybreak",sub="Ammurapi Shield",range="Kaja Bow",ammo=empty,
		...
		body="Twilight Cloak",hands="Leth. Gantherots +3",ring1="Metamor. Ring +1",ring2="Stikini Ring +1",
	...
	sets.midcast['Dark Magic'] = {main="Rubicundity",sub="Ammurapi Shield",range="Kaja Bow",ammo=empty,
		...
		body="Atrophy Tabard +3",hands="Leth. Gantherots +3",ring1="Metamor. Ring +1",ring2="Stikini Ring +1",
	...
	sets.weapons.DualWeaponsAcc = {main="Naegling",sub="Ternion Dagger +1"}
	...
	sets.weapons.EnspellOnly = {main="Norgish Dagger",sub="Aern Dagger",range="Kaja Bow"}
