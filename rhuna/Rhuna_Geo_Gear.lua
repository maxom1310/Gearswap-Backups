...
function init_gear_sets()
    ...
    body={ name="Merlinic Jubbah", augments={'Mag. Acc.+18','"Fast Cast"+6','MND+6','"Mag.Atk.Bns."+14',}},
	...
	sets.precast.FC.Geomancy = set_combine(sets.precast.FC, {range="Dunna",ammo=empty, back={ name="Lifestream Cape", augments={'Geomancy Skill +3','Indi. eff. dur. +20','Pet: Damage taken -1%',}},})
