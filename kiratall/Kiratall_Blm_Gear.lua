...
function init_gear_sets()
    ...
    sets.precast.WS['Myrkr'] = {    ammo="Sapience Orb",
    ...
    sets.midcast['Enfeebling Magic'] = {    head="C. Palug Crown",
    ...
    sets.midcast['Enfeebling Magic'].Resistant = {   head="C. Palug Crown",
    main={ name="Marin Staff +1", augments={'Path: A',}},
    sub="Khonsu",
    ammo="Pemphredo Tathlum",
    head={ name="Amalric Coif +1", augments={'INT+12','Mag. Acc.+25','Enmity-6',}},
   ...
   ammo="Sapience Orb",
	...
	sets.midcast.Aspir.Death = {   ammo="Sapience Orb",
    head="Pixie Hairpin +1",
    body={ name="Amalric Doublet +1", augments={'MP+80','Mag. Acc.+20','"Mag.Atk.Bns."+20',}},
    hands={ name="Amalric Gages +1", augments={'INT+12','Mag. Acc.+20','"Mag.Atk.Bns."+20',}},
    legs={ name="Merlinic Shalwar", augments={'Mag. Acc.+20 "Mag.Atk.Bns."+20','Magic burst dmg.+6%','INT+6','Mag. Acc.+6','"Mag.Atk.Bns."+15',}},
	...
	sets.midcast.Death = { ammo="Sapience Orb",
    head="Pixie Hairpin +1",
    body={ name="Amalric Doublet +1", augments={'MP+80','Mag. Acc.+20','"Mag.Atk.Bns."+20',}},
    hands={ name="Amalric Gages +1", augments={'INT+12','Mag. Acc.+20','"Mag.Atk.Bns."+20',}},
    legs={ name="Merlinic Shalwar", augments={'Mag. Acc.+20 "Mag.Atk.Bns."+20','Magic burst dmg.+6%','INT+6','Mag. Acc.+6','"Mag.Atk.Bns."+15',}},
    ...
    sets.midcast.Stun = {main=gear.grioavolr_fc_staff,sub="Clerisy Strap +1",ammo="Hasty Pinion +1",
        ...
        back=gear.nuke_jse_back,waist="Cetl Belt",legs="Psycloth Lappas", feet={ name="Merlinic Crackows", augments={'Mag. Acc.+23 "Mag.Atk.Bns."+23','"Fast Cast"+2','Mag. Acc.+12',}},}
	...
	sets.midcast.Impact = {    main={ name="Marin Staff +1", augments={'Path: A',}},
    sub="Khonsu",
    ammo="Pemphredo Tathlum",
	head=empty,
   ...
   back="Taranus's Cape",}
	...
	sets.midcast['Elemental Magic'].HighTierNuke = set_combine(sets.midcast['Elemental Magic'], {    head="Ea Hat +1",
    body="Ea Houppe. +1",
    legs="Ea Slops +1",})
	sets.midcast['Elemental Magic'].HighTierNuke.Resistant = set_combine(sets.midcast['Elemental Magic'].Resistant, { head="Ea Hat +1",
    body="Ea Houppe. +1",
    legs="Ea Slops +1",})
	sets.midcast['Elemental Magic'].HighTierNuke.Fodder = set_combine(sets.midcast['Elemental Magic'].Fodder, {head="Ea Hat +1",
    body="Ea Houppe. +1",
    legs="Ea Slops +1",})
