...
function init_gear_sets()
	...
	sets.precast.WS['Stardiver'] = set_combine(sets.precast.WS, {    ammo="Crepuscular Pebble",
   ...
   left_ring="Moonlight Ring",
	...
	sets.defense.PDTReraise = set_combine(sets.defense.PDT, {head="Twilight Helm",body="Crepuscular Mail",})
   ...
   left_ring="Moonlight Ring",
	...
	sets.defense.MDTReraise = set_combine(sets.defense.MDT, {head="Twilight Helm",body="Crepuscular Mail",})
    ...
    sets.passive.Twilight = {head="Twilight Helm", body="Crepuscular Mail"}
