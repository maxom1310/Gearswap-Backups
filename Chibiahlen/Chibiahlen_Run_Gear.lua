function user_job_setup()
	...
	state.HybridMode:options('Tank','Normal','DD')
	...
	state.Weapons:options('None','Epeo','Prime','Lionheart','Axe','DualWeapons','MalSword')
...
function init_gear_sets()
    ...
    sets.precast.JA['Vallation'] = set_combine(sets.Enmity,{body="Runeist Coat +4",legs="Futhark Trousers +3"})
    ...
    sets.precast.JA['Swordplay'] = set_combine(sets.Enmity,{hands="Futhark Mitons +4"})
    ...
    sets.precast.JA['Vallation'].DT = set_combine(sets.Enmity.DT,{body="Runeist Coat +4", legs="Futhark Trousers +3"})
    ...
    sets.precast.JA['Swordplay'].DT = set_combine(sets.Enmity.DT,{hands="Futhark Mitons +4"})
    ...
    sets.precast.WS['Fimbulvetr'].Acc = set_combine(sets.precast.WS.Acc,{})
	sets.precast.WS['Fimbulvetr'].HighAcc = set_combine(sets.precast.WS.HighAcc,{})
	sets.precast.WS['Fimbulvetr'].FullAcc = set_combine(sets.precast.WS.FullAcc,{})
   ...
   -- legs={ name="Futhark Trousers +1", augments={'Enhances "Inspire" effect',}},
	...
	sets.weapons.MalSword = {main="Malignance Sword",sub="Regis"}
