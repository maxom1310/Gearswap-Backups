...
function init_gear_sets()
	...
	sets.precast.FC.Dispelga = set_combine(sets.precast.FC, {main="Daybreak",sub="Archduke's Shield"})
    ...
    body={ name="Nyame Mail", augments={'Path: B',}},
    hands={ name="Fanatic Gloves", augments={'MP+15','Healing magic skill +1','"Conserve MP"+2',}},
    legs="Ebers Pant. +3",
    feet="Ebers Duckbills +3",
    waist="Luminary Sash",
   ...
   back={ name="Alaunus's Cape", augments={'VIT+20','Eva.+20 /Mag. Eva.+20','Mag. Evasion+10','"Fast Cast"+10','Damage taken-5%',}},}
	...
	sets.midcast.Cursna = {      ammo="Hasty Pinion +1",
    head="Ebers Cap +3",
    body="Ebers Bliaut +3",
    hands={ name="Fanatic Gloves", augments={'MP+15','Healing magic skill +1','"Conserve MP"+2',}},
    legs="Ebers Pant. +3",
