function user_job_setup()
	...
	state.Weapons:options('None','Naegling','Sequence','DualWeapons','DualSavage','DualWeaponsAcc','DualEvisceration','DualClubs','DualAeolian','DualProcDaggers','EnspellOnly','EnspellDW')
...
function init_gear_sets()
    ...
    legs={ name="Chironic Hose", augments={'Mag. Acc.+23 "Mag.Atk.Bns."+23','"Fast Cast"+6','MND+15','Mag. Acc.+15','"Mag.Atk.Bns."+4',}},
   ...
   ammo="Crepuscular Pebble",
	...
	sets.EnhancingSkill = {body={ name="Viti. Tabard +4", augments={'Enhances "Chainspell" effect',}},head="Befouled Crown",
	  neck="Hoxne Torque",left_ear="Andoaa Earring",
	ear2="Mimir Earring",hands="Viti. Gloves +4",back="Ghostfyre Cape",waist="Olympus Sash",legs="Atrophy Tights +4",  feet="Leth. Houseaux +3",    left_ring={name="Stikini Ring +1",bag="Wardrobe 3"},
    right_ring={name="Stikini Ring +1",bag="Wardrobe 2"},}
    ...
    left_ring={name="Stikini Ring +1",bag="Wardrobe 3"},
	right_ring="Kishar Ring",
    back={ name="Sucellos's Cape", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','Haste+10','Damage taken-5%',}},}
    ...
    sets.midcast['Elemental Magic'].Resistant = {     ammo="Aurgelmir Orb +1",
    head="Malignance Chapeau",
    body="Malignance Tabard",
    hands="Malignance Gloves",
    ...
    sets.midcast.Drain = {    ammo="Hasty Pinion +1",
    head="Pixie Hairpin +1",
    body={ name="Merlinic Jubbah", augments={'Mag. Acc.+30','"Drain" and "Aspir" potency +11','CHR+3',}},
    hands={ name="Chironic Gloves", augments={'Mag. Acc.+24 "Mag.Atk.Bns."+24','"Drain" and "Aspir" potency +9','CHR+4','Mag. Acc.+15','"Mag.Atk.Bns."+12',}},
    ...
    sets.HPCure = {range=empty,ammo="Hasty Pinion +1",
        ...
        body="Viti. Tabard +4",hands="Kaykaus Cuffs",ring1="Gelatinous Ring +1",ring2="Meridian Ring",
	...
	sets.Self_Phalanx = {     ammo="Staunch Tathlum +1",
    ...
    back={ name="Ghostfyre Cape", augments={'Enfb.mag. skill +5','Enha.mag. skill +10','Mag. Acc.+9','Enh. Mag. eff. dur. +20',}},}
	sets.TPEat = {}
	sets.DayIdle = {}
	sets.NightIdle = {}
	...
	sets.weapons.DualSavage = {main="Naegling",sub="Machaera +2"}
