...
--	but rather the specific roll like Chaos and such.  So rules needed instead for CorsairRoll above
	sets.precast["Double-Up"] = set_combine(sets.aftercast.Idle, {head="Lanun Tricorne",neck="Regal Necklace",hands="Chasseur's Gants +3",rring="Luzaf's Ring",back="Camulus's Mantle",})
	...
	sets.precast["Triple Shot"] = {body="Chasseur's Frac +1",hands="Lanun gants +1",}
