...
function init_gear_sets()
	...
	sets.buff['Chain Affinity'] = {head="Hashishin Kavuh +2"}
 ...
 --waist="Olseni Belt",
  ...
  feet="Malignance boots",
	...
	sets.midcast['Blue Magic']['Carcharian Verve'] = set_combine(sets.midcast['Blue Magic'].Buff, {head="Amalric Coif +1",hands="Hashi. Bazu. +2",waist="Emphatikos Rope",legs="Shedir Seraweels"})
