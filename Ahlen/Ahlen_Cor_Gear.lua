...
function user_job_setup()
	...
	state.Weapons:options('None','Default','DualSavage','Terminus','RangedTerminus','DualLeadenRanged','DualLeadenMelee','DWEvis','DualAeolian','DualRanged','SWSavage','SWWildfire','Low','DualWildMelee','SWOngo','DualFomal','SWFomal','SWEvis','SWmeeleeFomal')
...
function init_gear_sets()
   ...
   waist="Kentarch Belt +1",
    ...
    sets.precast.WS['Hot Shot'] = {    main={ name="Rostam", augments={'Path: B',}},
