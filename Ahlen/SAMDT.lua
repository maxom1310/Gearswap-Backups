...
function user_setup()
    state.OffenseMode:options('Normal', 'Meva','Hybrid', 'Pdt','Nyame','Subtle')
...
function init_gear_sets()
    ...
    sets.precast.JA.Meditate = {head="Wakido Kabuto",hands="Sakonji Kote", back="Smertrios's Mantle"}
    ...
    sets.precast.WS['Tachi: Kasha'] = set_combine(sets.precast.WS, {neck="Samurai's Nodowa +2", helm="Nyame Helm", feet="Nyame Sollerets",})
	...
	head="Flam. Zucchetto +2",feet="Flam. Gambieras +2",
	neck="Samurai's Nodowa +2",left_ear="Digni. Earring",
    left_ring="Regal Ring", right_ring="Metamor. Ring +1",})
