...
function init_gear_sets()
   ...
   legs="Eri. Leg Guards +3",
    ...
    sets.precast.JA['Vallation'] = set_combine(sets.Enmity,{body="Runeist Coat +4",legs="Futhark Trousers +4"})
    ...
    sets.precast.JA['Liement'] = set_combine(sets.Enmity,{body="Futhark Coat +4"})
    sets.precast.JA['Gambit'] = set_combine(sets.Enmity,{hands="Runeist Mitons +4"})
    sets.precast.JA['Rayke'] = set_combine(sets.Enmity,{feet="Futhark Boots +4"})
    sets.precast.JA['Elemental Sforzo'] = set_combine(sets.Enmity,{body="Futhark Coat +4"})
    ...
    sets.precast.JA['Vallation'].DT = set_combine(sets.Enmity.DT,{body="Runeist Coat +4", legs="Futhark Trousers +4"})
    ...
    sets.precast.JA['Liement'].DT = set_combine(sets.Enmity.DT,{body="Futhark Coat +4"})
    sets.precast.JA['Gambit'].DT = set_combine(sets.Enmity.DT,{hands="Runeist Mitons +4"})
    sets.precast.JA['Rayke'].DT = set_combine(sets.Enmity.DT,{feet="Futhark Boots +4"})
    sets.precast.JA['Elemental Sforzo'].DT = set_combine(sets.Enmity.DT,{body="Futhark Coat +4"})
	...
	sets.precast.FC['Enhancing Magic'] = set_combine(sets.precast.FC, {legs="Futhark Trousers +4"})
    ...
    sets.midcast['Enhancing Magic'] = set_combine(sets.midcast.FastRecast,{head="Erilaz Galea +3",legs="Futhark Trousers +4",hands="Regal Gauntlets",})
    sets.midcast['Phalanx'] = set_combine(sets.midcast['Enhancing Magic'],{left_ear="Mimir Earring",  head={ name="Fu. Bandeau +4", augments={'Enhances "Battuta" effect',}},
    body="Sworn Platemail",
	...
	sets.Cure_Received = {}
	sets.Self_Refresh = {}
	sets.Phalanx_Received = {   head={ name="Fu. Bandeau +4", augments={'Enhances "Battuta" effect',}},
    body="Sworn Platemail",
    hands="Sworn Gauntlets",
    feet="Sworn Sabatons",
