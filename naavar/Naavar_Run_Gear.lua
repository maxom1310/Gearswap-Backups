...
function init_gear_sets()
    ...
    sets.Enmity = {     main={ name="Aettir", augments={'Accuracy+70','Mag. Evasion+50','Weapon skill damage +10%',}},
    sub="Utu Grip",
    ...
    sets.Enmity.SIRD = {      main={ name="Aettir", augments={'Accuracy+70','Mag. Evasion+50','Weapon skill damage +10%',}},
    sub="Utu Grip",
    ammo="Crepuscular Pebble",
    head="Halitus Helm",
    body={ name="Emet Harness +1", augments={'Path: A',}},
    ...
    sets.Enmity.SIRDT = {    main={ name="Aettir", augments={'Accuracy+70','Mag. Evasion+50','Weapon skill damage +10%',}},
    sub="Utu Grip",
    ammo="Crepuscular Pebble",
    head="Halitus Helm",
    body={ name="Emet Harness +1", augments={'Path: A',}},
    ...
    legs={ name="Herculean Trousers", augments={'"Mag.Atk.Bns."+22','"Fast Cast"+6','STR+1',}},
    ...
    sets.midcast['Enhancing Magic'] = set_combine(sets.midcast.FastRecast,{head="Erilaz Galea +2",legs="Futhark Trousers +3",hands="Regal Gauntlets",})
	...
	-- Weapons sets
	sets.weapons.Epeo = {main="Aettir",sub="Utu Grip"}
