...
function init_gear_sets()
    ...
    sets.resting = {ammo="Staunch Tathlum +1",
        head=gear.valorous_wsd_head,neck="Elite Royal Collar",ear1="Etiolation Earring",ear2="Sanare Earring",
    ...
    sets.idle.Weak = {ammo="Staunch Tathlum +1",
        head="Twilight Helm",neck="Elite Royal Collar",ear1="Etiolation Earring",ear2="Sanare Earring",
    ...
    sets.defense.PDT = {ammo="Staunch Tathlum +1",
        head="Loess Barbuta +1",neck="Elite Royal Collar",ear1="Etiolation Earring",ear2="Sanare Earring",
	...
	sets.engaged.DTLite = {ammo="Staunch Tathlum +1",
        head="Ynglinga Sallet",neck="Elite Royal Collar",ear1="Cessance Earring",ear2="Brutal Earring",
        body="Tartarus Platemail",hands="Wakido Kote +3",ring1="Defending Ring",ring2="Patricius Ring",
    ...
    sets.engaged.Fodder.DTLite = {ammo="Staunch Tathlum +1",
        head="Flam. Zucchetto +2",neck="Elite Royal Collar",ear1="Cessance Earring",ear2="Brutal Earring",
        body="Tartarus Platemail",hands="Wakido Kote +3",ring1="Defending Ring",ring2="Patricius Ring",
        back=gear.stp_jse_back,waist="Ioskeha Belt",legs="Wakido Haidate +3",feet="Amm Greaves"}	
...
--[[Right now Adoulin sets are the same as non-Adoulin.
    ...
    sets.engaged.Adoulin.FullAcc.PDT = {ammo="Staunch Tathlum +1",
        head="Flam. Zucchetto +2",neck="Elite Royal Collar",ear1="Mache Earring +1",ear2="Telos Earring",
        body="Tartarus Platemail",hands=gear.valorous_wsd_hands,ring1="Defending Ring",ring2="Patricius Ring",
