function user_job_setup()
	...
	state.Weapons:options('None','BurtDuban','BurtAegis','BurtSri','BurtPriwen','DubanSakpata', 'NaeglingDuban','NaeglingAegis','NaeglingBlurred','Aeolian')
...
function init_gear_sets()
    ...
    body={name="Rev. Surcoat +4",priority=10,},
 ...
 --   left_ear="Etiolation Earring",
   ...
   sets.precast.WS['Sanguine Blade'] = {  ammo="Crepuscular Pebble",
    ...
    left_ring="Moonlight Ring",
    right_ring="Vengeful Ring",
    back={ name="Rudianos's Mantle", augments={'VIT+20','Eva.+20 /Mag. Eva.+20','Mag. Evasion+10','"Cure" potency +10%','Damage taken-5%',}},}
	...
	sets.weapons.DubanSakpata = {main="Sakpata's Sword",sub="Duban"}
