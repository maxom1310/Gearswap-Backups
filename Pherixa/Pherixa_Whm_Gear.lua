...
function init_gear_sets()
	...
	sets.midcast.Cure.DT = {main="Queller Rod",sub="Genmei Shield",ammo="Staunch Tathlum +1",
		head="Gende. Caubeen +1",neck="Elite Royal Collar",ear1="Nourish. Earring +1",ear2="Glorious Earring",
	...
	sets.idle.PDT = {main="Bolelabunga",sub="Genmei Shield",ammo="Staunch Tathlum +1",
		head="Gende. Caubeen +1",neck="Elite Royal Collar",ear1="Etiolation Earring",ear2="Ethereal Earring",
	...
	sets.defense.MDT = {main="Mafic Cudgel",sub="Genmei Shield",ammo="Staunch Tathlum +1",
		head="Gende. Caubeen +1",neck="Elite Royal Collar",ear1="Etiolation Earring",ear2="Sanare Earring",
