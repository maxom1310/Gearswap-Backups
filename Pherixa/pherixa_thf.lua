...
function user_setup()
    state.OffenseMode:options('Normal', 'Acc', 'Mod','Hybrid')
...
function init_gear_sets()
    ...
    sets.TreasureHunter = {feet="Skulk. Poulaines +3",waist="Chaac Belt",}
    sets.ExtraRegen = {}
    sets.Kiting = {}
    ...
    feet="Skulk. Poulaines +3",waist="Chaac Belt",
	...
	sets.precast.WS['Evisceration'].Hybrid = set_combine(sets.precast.WS['Evisceration'], {})
	...
	sets.precast.WS["Rudra's Storm"].Hybrid = set_combine(sets.precast.WS["Rudra's Storm"], {})
	...
	sets.precast.WS['Shark Bite'].Hybrid = set_combine(sets.precast.WS['Shark Bite'], {})
	...
	sets.precast.WS['Mandalic Stab'].Hybrid = set_combine(sets.precast.WS['Mandalic Stab'], {})
  ...
  back={ name="Toutatis's Cape", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','Weapon skill damage +10%','Damage taken-5%',}},
    ...
    back={ name="Toutatis's Cape", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+10','"Dbl.Atk."+10','Damage taken-5%',}},
		 ...
		 sets.engaged.Hybrid = {
    main={ name="Gandring", augments={'Path: B',}},
    sub={ name="Gleti's Knife", augments={'Path: A',}},
    ammo="Coiste Bodhar",
    head="Malignance Chapeau",
    body="Malignance Tabard",
