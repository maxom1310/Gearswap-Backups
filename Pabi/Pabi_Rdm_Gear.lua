function user_job_setup()
	...
	state.AutoBuffMode:options('Off','AutoMeleeMND','AutoMeleeStr','AutoMeleeDex')
...
--	send_command('bind !r gs c set skipprocweapons true;gs c reset weaponskillmode;gs c set weapons none')
	send_command('bind !q gs c set skipprocweapons false;gs c set weapons DualProcDaggers;gs c set weaponskillmode proc')
		...
		send_command('bind !^@f9 input /equipset 16;wait1;input /echo Maxentus;wait1;aws use black halo' )
...
function init_gear_sets()
	...
	sets.precast.WS['Chant du Cygne'] = {        ammo="Crepuscular Pebble",
    head={ name="Nyame Helm", augments={'Path: B',}},
    body={ name="Nyame Mail", augments={'Path: B',}},
    hands={ name="Nyame Gauntlets", augments={'Path: B',}},
    legs={ name="Nyame Flanchard", augments={'Path: B',}},
	...
	sets.TreasureHunter = set_combine(sets.TreasureHunter, {head="Volte Cap", Hands="Volte Bracers",legs={ name="Chironic Hose", augments={'"Dual Wield"+3','Accuracy+10','"Treasure Hunter"+1','Mag. Acc.+7 "Mag.Atk.Bns."+7',}},})
    ...
    right_ring="Stikini Ring +1",
     back={ name="Sucellos's Cape", augments={'MND+20','Eva.+20 /Mag. Eva.+20','MND+10','"Cure" potency +10%','Damage taken-5%',}},}
    ...
    back={ name="Ghostfyre Cape", augments={'Enfb.mag. skill +5','Enha.mag. skill +7','Enh. Mag. eff. dur. +20',}},}
	...
	sets.EnhancingSkill = {body="Viti. Tabard +3",head="Befouled Crown",--neck="Incanter's Torque",
	  neck={ name="Dls. Torque +2", augments={'Path: A',}},  left_ear="Andoaa Earring",
	ear2="Mimir Earring",hands="Viti. Gloves +3",back={ name="Ghostfyre Cape", augments={'Enfb.mag. skill +5','Enha.mag. skill +10','Enh. Mag. eff. dur. +17',}},waist="Olympus Sash",legs="Atrophy Tights +3",  feet="Leth. Houseaux +3",    left_ring={name="Stikini Ring +1",bag="Wardrobe 3"},
    right_ring={name="Stikini Ring +1",bag="Wardrobe 2"},}
    ...
    body="Lethargy Sayon +3",
    hands="Leth. Ganth. +3",
    legs={ name="Chironic Hose", augments={'Mag. Acc.+30','VIT+2','Accuracy+9 Attack+9','Mag. Acc.+20 "Mag.Atk.Bns."+20',}},
	...
	sets.midcast.SkillBasedEnfeebling = set_combine(sets.midcast['Enfeebling Magic'], {hands="Leth. Ganth. +3"})--ear1="Vor Earring",hands="Leth. Ganth. +3",legs="Psycloth Lappas"})
	...
	sets.midcast.Impact = {main="Daybreak",sub="Ammurapi Shield",range="Kaja Bow",ammo=empty,
		...
		body="Twilight Cloak",hands="Leth. Ganth. +3",ring1="Metamor. Ring +1",ring2="Stikini Ring +1",
